...
<body class="bg-[#0f0f0f] text-white min-h-screen font-sans">
    ...
    <section id="accueil" class="min-h-screen pt-32 pb-20 flex items-center" data-aos="fade-up"
        data-aos-duration="1000">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            <!-- Texte gauche + réseaux sociaux -->
            <div class="space-y-8 md:space-y-10">
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight" data-aos="fade-right"
                    data-aos-delay="200">
                    Bonjour,<br>
                    je suis <span class="text-yellow-400">Marcelin</span>
                </h1>
                <p class="text-xl md:text-2xl text-gray-300 leading-relaxed" data-aos="fade-right" data-aos-delay="400">
                ...
                <div class="flex flex-wrap gap-5 pt-4" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <a href="https://www.facebook.com/OrtegaEditor/directory_links" target="_blank"
                        rel="noopener noreferrer"
                        class="flex items-center gap-3 text-gray-300 hover:text-yellow-400 transition-colors duration-300 text-xl">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                            <path
                ...
                <!-- Bouton contact -->
                <div class="pt-6" data-aos="fade-up" data-aos-delay="800">
                    <a href="#contact"
    ...
    <!-- Section À propos -->
    <section id="apropos" class="py-20 bg-black/40" data-aos="fade-up" data-aos-duration="1000">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-4xl md:text-5xl font-bold text-yellow-400 mb-10 text-center" data-aos="zoom-in"
                data-aos-delay="200">À propos</h2>
    ...
    <!-- Section Compétences -->
    <section id="competences" class="py-20" data-aos="fade-up" data-aos-duration="1000">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-4xl md:text-5xl font-bold text-yellow-400 mb-12 text-center" data-aos="zoom-in"
                data-aos-delay="200">
                Compétences
            </h2>
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Frontend -->
                <div class="bg-black/50 p-8 rounded-2xl border border-yellow-900/30 hover:border-yellow-500/50 transition-all duration-300"
                ...
                <div class="bg-black/50 p-8 rounded-2xl border border-yellow-900/30 hover:border-yellow-500/50 transition-all duration-300"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="skill-box">
                            <i class="fa-server text-yellow-300"></i>
                            <span>Xampp</span>
                        </div>
                    </div>
                </div>
    ...
    <!-- Section Projets -->
    <section id="projets" class="py-20 bg-black/40" data-aos="fade-up" data-aos-duration="1000">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-4xl md:text-5xl font-bold text-yellow-400 mb-12 text-center" data-aos="zoom-in"
                data-aos-delay="200">Projets</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                ...
                <div class="group bg-black/60 rounded-2xl overflow-hidden border border-yellow-900/40 hover:border-yellow-500/60 transition-all duration-300 shadow-xl hover:shadow-yellow-900/30"
                    ...
                    <div class="p-6 md:p-7">
                        ...
                        <a href="https://github.com/OrtegaEditor/G-stock" target="_blank"
                            class="inline-block mb-4 px-5 py-2 bg-yellow-500 text-black font-semibold rounded-full hover:bg-yellow-400 transition-colors duration-300">
                            GitHub
                        </a>
                ...
                <div class="group bg-black/60 rounded-2xl overflow-hidden border border-yellow-900/40 hover:border-yellow-500/60 transition-all duration-300 shadow-xl hover:shadow-yellow-900/30"
                    ...
                    <div class="p-6 md:p-7">
                        ...
                        <a href="https://github.com/OrtegaEditor/manichicks" target="_blank"
                            class="inline-block mb-4 px-5 py-2 bg-yellow-500 text-black font-semibold rounded-full hover:bg-yellow-400 transition-colors duration-300">
                            GitHub
                        </a>
                        <div class="flex flex-wrap gap-3">
                ...
                <div class="group bg-black/60 rounded-2xl overflow-hidden border border-yellow-900/40 hover:border-yellow-500/60 transition-all duration-300 shadow-xl hover:shadow-yellow-900/30"
                    ...
                    <div class="relative h-56 md:h-64 bg-gray-900 overflow-hidden">
                        <img src="/images/portfolio.png" alt="Mon portfolio - Laravel"
                            class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                            onerror="this.src='https://via.placeholder.com/600x400/111/eee?text=Portfolio';" />
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                    </div>
                    <div class="p-6 md:p-7">
                        <h3 class="text-2xl font-bold text-yellow-400 mb-3">Mon site personnel</h3>
                        <p class="text-gray-300 mb-6 leading-relaxed">
                            Mon CV en ligne
                        </p>
                        <a href="https://github.com/OrtegaEditor/Monportfolio-Laravel" target="_blank"
                            class="inline-block mb-4 px-5 py-2 bg-yellow-500 text-black font-semibold rounded-full hover:bg-yellow-400 transition-colors duration-300">
                            GitHub
                        </a>
                        <div class="flex flex-wrap gap-3">
    ...
    <!-- Section Services -->
    <section id="services" class="py-20" data-aos="fade-up" data-aos-duration="1000">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-4xl md:text-5xl font-bold text-yellow-400 mb-12 text-center" data-aos="zoom-in"
                data-aos-delay="200">Services</h2>
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-black/50 p-8 rounded-2xl border border-yellow-900/30 hover:border-yellow-500/50 transition-all duration-300"
                    data-aos="fade-right" data-aos-delay="200">
    ...
    <!-- Section Contact -->
    <section id="contact" class="py-20 bg-black/60" data-aos="fade-up" data-aos-duration="1000">
        <h2 class="text-4xl md:text-5xl font-bold text-yellow-400 mb-12 text-center" data-aos="zoom-in"
        ...
        <form action="{{ route('contact.store') }}" method="POST" class="space-y-6 max-w-2xl mx-auto">
            ...
            <textarea name="message" rows="5" placeholder="Votre message"
                class="w-full px-6 py-4 bg-black border border-yellow-500/40 rounded-xl text-white focus:outline-none focus:border-yellow-400 transition-all duration-300 focus:shadow-[0_0_15px_rgba(234,179,8,0.3)]"
                data-aos="fade-up" data-aos-delay="900"></textarea>
            <button type="submit"
                class="w-full px-8 py-4 bg-yellow-500 text-black font-bold text-lg rounded-xl hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-600/50"
                data-aos="fade-up" data-aos-delay="1000">
                Envoyer le message
            </button>
            @if (session('success'))
                <p class="text-green-400 text-center mt-4" data-aos="fade-in">{{ session('success') }}</p>
            @endif
        </form>
    </section>
